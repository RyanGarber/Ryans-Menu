function audio_play_from_entity(entity, sound_group, sound_name)
    AUDIO.PLAY_SOUND_FROM_ENTITY(-1, sound_name, entity, sound_group, true, 20)
end

function audio_play_at_coords(coords, sound_group, sound_name, range)
    AUDIO.PLAY_SOUND_FROM_COORD(-1, sound_name, coords.x, coords.y, coords.z, sound_group, true, range, 20)
end
